				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
							...
							<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#tambah-stok<?php echo $d['ProdukID']; ?>">
								Tambah Stok
							</button>
						</td>
					</tr>
					...
					<!-- Modal Tambah Stok-->
					<div class="modal fade" id="tambah-stok<?php echo $d['ProdukID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
								...
								<input type="hidden" name="ProdukID" value="<?php echo $d['ProdukID']; ?>">
									<div class="modal-body">
										<div class="form-group">
										<input type="number" name="TambahStok" value="<?php echo $d_produk['Stok']; ?>" class="form-control">
										</div>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
		...
		<div class="modal-content">
			...
			<form action="proses_simpan_barang.php" method="post">
				...
				<div class="form-group">
						...
						<input type="text" name="ProdukID" class="form-control">
					</div>				
					<div class="form-group">
						<label>Nama Produk</label>
